...
const solanaAddressSchema = z
  ...
  .regex(
    BASE58_PATTERN,
    "EndereÃ§o deve ser base58 vÃ¡lido (sem 0, O, I, l)"
  );
...
export const tokenDraftSchema = z
  .object({
    name: z
      .string()
      .min(1, "Nome do token Ã© obrigatÃ³rio")
      .max(32, "Nome do token deve ter no mÃ¡ximo 32 caracteres"),
    ...
    twitterHandle: z
      ...
      .regex(
        /^[a-zA-Z0-9_]{1,15}$/,
        "Twitter handle deve ter 1-15 caracteres alfanumÃ©ricos ou underscore (sem @)"
      )
      .optional(),
    ...
    telegramHandle: z
      ...
      .regex(
        /^[a-zA-Z0-9_]{5,32}$/,
        "Telegram handle deve ter 5-32 caracteres alfanumÃ©ricos ou underscore"
      )
      .optional(),
  })
