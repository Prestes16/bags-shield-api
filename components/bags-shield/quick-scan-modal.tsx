  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 animate-in slide-in-from-bottom duration-300">
        <div className="bg-bg-card border-t border-border-subtle rounded-t-3xl shadow-2xl max-w-lg mx-auto">
          {/* Handle */}
          ...
          <div className="flex items-center justify-between px-5 pb-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--cyan-primary)]/20 to-[var(--cyan-secondary)]/20 flex items-center justify-center border border-[var(--cyan-primary)]/30">
                <Scan className="w-5 h-5 text-[var(--cyan-primary)]" />
              </div>
              <div>
                <h2 className="text-lg font-semibold text-text-primary">
                  {t.quickScan?.title || "Quick Scan"}
                </h2>
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-9 h-9 rounded-full bg-bg-card-hover flex items-center justify-center text-text-muted hover:text-text-primary transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="px-5 pb-6">
            ...
            <div className="mb-4">
              ...
              {/* Helper text */}
              <div className="flex items-start gap-2 mt-3 p-3 bg-bg-card-hover rounded-lg">
                <HelpCircle className="w-4 h-4 text-[var(--cyan-primary)] mt-0.5 flex-shrink-0" />
                <p className="text-xs text-text-muted">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={onClose}
                className="h-12 rounded-xl font-medium text-text-secondary bg-bg-card-hover hover:bg-border-subtle transition-all border border-border-subtle"
              >
                {t.common.cancel}
              </button>
              <button
                ...
                className={cn(
                  ...
                  isValid
                    ? "bg-gradient-to-r from-[var(--cyan-primary)] to-[var(--cyan-secondary)] text-white shadow-[0_0_16px_var(--cyan-glow)] hover:shadow-[0_0_24px_var(--cyan-glow)] hover:opacity-95"
                    : "bg-bg-card-hover text-text-muted border border-border-subtle cursor-not-allowed"
                )}
              >
                <Scan className="w-4 h-4" />
                {t.quickScan?.scanButton || "Scan"}
              </button>
            </div>
          </div>
