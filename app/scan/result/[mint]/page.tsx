...
const mockResult: ScanResultData = {
  ...
  score: 65,
  grade: "C",
  summary: "Risco Moderado devido Ã  concentraÃ§Ã£o de holders.",
  badges: [
  ...
  findings: [
    {
      ...
      severity: "high",
      description: "Top 10 holders possuem 45% do supply. Isso pode indicar risco de manipulaÃ§Ã£o de preÃ§o.",
    },
    {
      title: "Liquidez Moderada",
      severity: "medium",
      description: "Liquidez atual Ã© suficiente para trades pequenos, mas pode ser insuficiente para grandes volumes.",
    },
    {
      title: "Token MintÃ¡vel",
      severity: "medium",
...
export default function ScanResultPage() {
  ...
  useEffect(() => {
    ...
    const fetchResult = async () => {
      ...
      try {
        ...
        // Verificar se a resposta Ã© de sucesso
        if (!data.success) {
  ...
  const copyToClipboard = async () => {
    ...
    try {
      await (globalThis as any).navigator?.clipboard?.writeText?.(mint);
      setHasCopied(true);
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      // Se nÃ£o tem Web Share, cai pro copy
      ...
      // AbortError = usuÃ¡rio cancelou o share; nÃ£o Ã© "erro"
      ...
      try {
        ...
        setToastMessage("NÃ£o foi possÃ­vel compartilhar");
      }
    }
  };
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 border-2 border-orange-300 dark:border-orange-700">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-4">
                VocÃª excedeu o limite de requisiÃ§Ãµes. Por favor, aguarde antes de tentar novamente.
              </p>
              ...
              {cooldown > 0 && (
                <div className="mb-6">
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    Tempo restante atÃ© poder escanear novamente
                  </p>
                </div>
              )}
            </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 pb-24 md:pb-8">
      ...
      {/* Barra de botÃµes - fixa no mobile, normal no desktop */}
