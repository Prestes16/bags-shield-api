    ...
    return (
      <div className="min-h-screen flex flex-col" style={{ background: "#020617" }}>
        ...
        <div className="sticky top-0 z-10 backdrop-blur-xl border-b" style={{ background: "rgba(2,6,23,0.95)", borderColor: "rgba(255,255,255,0.1)" }}>
          <div className="flex items-center justify-between gap-2 px-3 py-2.5 max-w-2xl mx-auto">
            <button
              type="button"
              onClick={() => router.push("/")}
              className="flex-shrink-0 w-9 h-9 rounded-lg flex items-center justify-center text-slate-400 hover:text-white active:scale-95 transition-all border touch-manipulation"
              style={{ background: "rgba(255,255,255,0.05)", borderColor: "rgba(255,255,255,0.1)" }}
            >
              <Home className="w-4 h-4" />
            </button>
            <span className="flex-1 text-center text-xs sm:text-sm font-semibold text-white whitespace-nowrap overflow-hidden text-ellipsis px-1">
            ...
            <button
              ...
              className="flex-shrink-0 px-2 sm:px-3 h-9 rounded-lg flex items-center justify-center gap-1.5 text-cyan-400 hover:text-cyan-300 active:scale-95 transition-all border border-cyan-500/30 bg-cyan-500/10 hover:bg-cyan-500/20 font-medium text-[11px] sm:text-xs whitespace-nowrap touch-manipulation"
            >
              <Shield className="w-3.5 h-3.5 flex-shrink-0" />
              <span className="hidden xs:inline">Novo Scan</span>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-2xl mx-auto px-4 pt-4 pb-8">
            {/* Token Info Card - Mobile First */}
            <div className="bg-bg-card/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-3 border border-border-subtle shadow-sm">
              {/* Token Header */}
              <div className="flex items-start gap-2.5 mb-3 pb-3 border-b border-border-subtle">
                    ...
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          ...
                          fallback.className = "relative w-12 h-12 rounded-full border-2 flex items-center justify-center";
                          fallback.style.background = "rgba(255,255,255,0.05)";
                          fallback.style.borderColor = "rgba(255,255,255,0.1)";
                          fallback.innerHTML = '<svg class="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="8" cy="15" r="4" strokeWidth="2"/><circle cx="16" cy="9" r="4" strokeWidth="2"/></svg>';
                ...
                <div className="flex-1 min-w-0">
                  <h1 className="text-sm sm:text-base font-bold text-white mb-0.5 truncate">
                    {tokenInfo.name}
                  </h1>
                  ...
                  {integrity.isVerified && (
                    <div className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-emerald-500/10 border border-emerald-500/30">
              ...
              {/* Score Display - Compact Mobile Grid */}
              <div className="grid grid-cols-2 gap-2">
                {/* Score Section */}
                <div className="p-3 rounded-lg bg-gradient-to-br from-bg-page/40 to-bg-page/20 border border-border-subtle/40">
                  <p className="text-[9px] text-text-muted mb-1.5 uppercase tracking-wider font-medium">
                    {t[lang].shieldScore}
                  </p>
                ...
                <div className="p-3 rounded-lg bg-gradient-to-br from-bg-page/40 to-bg-page/20 border border-border-subtle/40">
                  ...
                  <div
                    className={`inline-flex items-center justify-center px-4 py-1.5 rounded-lg font-bold text-2xl sm:text-3xl bg-gradient-to-br ${gradeColor} text-white shadow-md leading-none`}
